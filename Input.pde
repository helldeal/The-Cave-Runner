...
void mousePressed(){
  ...
  if(mouseButton==LEFT&&mouseX<width*2/3&&mouseX>width/3&&mouseY<height*6.5/8&&mouseY>height*5.5/8){page="animstart";} 
  }
  ...
  if(mouseButton==LEFT&&mouseX<width/2+700*width/2560&&mouseX>width/2+500*width/2560&&mouseY<height*7.3/8&&mouseY>height*6.7/8){
    settings2();transstart=-2.5*663*width/2560;decalstart=-2.5*663*width/2560;}
  }
}}
void mouseReleased(){
}
